...
- `/imports/[jobId]` shows load, not-found, populated batch, and “no spots in this import” states. Error/not-found is not an empty successful batch. Fix/add picks persist a ghost Place before the wishlist write; malformed wishlist ids are rejected with a 400 instead of surfacing as a 500.
