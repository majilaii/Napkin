...
import { useLaunchRouting } from '@/hooks/auth/useLaunchRouting';
import {
...
function RootLayoutNav() {
  ...
  // The root route gate: /auth, onboarding, guest routes, and leaving /auth
  // once signed in. Lives in a hook so it is unit tested (TICKET-247).
  useLaunchRouting(previewOnLaunch, previewLaunchConsumed);
