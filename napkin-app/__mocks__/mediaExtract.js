...
module.exports = {
    ...
    isBackgroundImportIntakeAvailable: () => false,
    getBackgroundImportInstallationId: () => null,
    getBackgroundImportCredential: () => null,
    setNativeBackgroundImportOwner: () => {},
    writeBackgroundImportCredential: () => false,
    clearBackgroundImportCredential: () => {},
    getPendingBackgroundImportRevocations: () => [],
    revokeBackgroundImportCredential: async () => false,
    getBackgroundImportTransfer: () => null,
    onBackgroundImportTransfer: () => () => {},
