...
export function reportMailto(
    ...
    if (review) lines.push(`Review: ${review.entry_id} by ${review.display_name}`);
    else lines.push('Which review:');
                                ...
                                <View style={styles.section} testID="guest-reviews">
                                    ...
                                    {reviews.map((review) => (
                                        <QuoteCard
                                            ...
                                            onPress={() => Alert.alert(review.display_name, undefined, [
                                                {
                                                    text: 'Report review',
                                                    onPress: () => openMail(reportMailto(restaurant, review)),
                                                },
                                    ...
                                    <Text style={[Type.metadata, styles.report, { color: palette.textMuted }]}>
                                        ...
                                        <Text
                                            ...
                                            onPress={() => openMail(reportMailto(restaurant))}
